...
**Triggered by commit:** `bcbb3f1` on `completedream` by appthemanger-ctrl  
**Commit message:** Merge pull request #412 from appthemanger-ctrl/copilot/find-workaround-for-cachecomponents-break
