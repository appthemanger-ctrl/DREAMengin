...
| **auto** | 2026-03-19 14:59 UTC | `7c6543a` | completedream | appthemanger-ctrl | no file changes<br>Merge pull request #246 from appthemanger-ctrl/copilot/update-privacy-defaults — Fix gold menu: shrink button, add Home route, wire system actions to work from any page<br> |
