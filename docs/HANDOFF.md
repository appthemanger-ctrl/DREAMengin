...
|---|---|---|---|---|---|
| **auto** | 2026-04-12 10:45 UTC | `a1b22ba` | completedream | appthemanger-ctrl | no file changes<br>Merge pull request #484 from appthemanger-ctrl/copilot/fix-engines-daydreams-redundancy — fix: align Side A/B roles across all engines — remove IDE/tools from Daydream surface, fix dead links, condense GameEngin launch catalog<br> |
| **auto** | 2026-04-12 10:45 UTC | `1f102c6` | copilot/fix-engines-daydreams-redundancy | appthemanger-ctrl | no file changes<br>Merge branch 'completedream' into copilot/fix-engines-daydreams-redundancy<br> |
