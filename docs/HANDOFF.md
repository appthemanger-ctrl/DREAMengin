...
|---|---|---|---|---|---|
| **auto** | 2026-04-14 09:59 UTC | `c4924d6` | completedream | appthemanger-ctrl | no file changes<br>Merge pull request #520 from appthemanger-ctrl/copilot/update-interaction-rules — feat: Universal Editor — tap-hold drag, edge transfer, DraggableModule system<br> |
| **auto** | 2026-04-14 07:57 UTC | `47c62b0` | copilot/update-interaction-rules | Copilot | +4 added  ~1 modified<br>feat: Universal Editor — DraggableModule, moduleRegistry, ModuleManifest — Reasoning: implements the Universal Editor spec — tap-hold (300ms) to lift a Dream Window, translate3d drag, edge detection (50px zone / 500ms hold), cross-runtime transfer via bridge.emit('module','transfer'), gold lift ring, sky-blue edge glow, keyboard Ctrl+Arrow transfer, and screen-reader announcements. Wraps DreamWidgetGrid Dream Windows with DraggableModule.  Architecture justification:   - docs/ARCHITECTURE.md §4   — Universal Dream Window model   - docs/ARCHITECTURE.md §8   — Gold=action, Sky-blue=live/connected   - docs/ARCHITECTURE.md §10  — render-on-demand; transform:translate3d; rAF   - docs/ARCHITECTURE.md §12  — bridge as cross-runtime bus   - docs/LAW.md §3            — every visible action must do something real   - docs/LAW.md §4            — Dream Windows are canonical modular containers  Performance impact: GPU-composited transform:translate3d only; willChange set only when lifted; edge detection batched via requestAnimationFrame; no setInterval; no layout reads during drag.  Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/6c23190a-3c10-46c6-876e-f656a48e091a  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>➕: `components/draggable/DraggableModule.tsx`, `lib/runtime/moduleRegistry.ts`, `tests/module-registry.test.ts`, `types/module-manifest.ts`<br>✏️: `components/home/DreamWidgetGrid.tsx` |
