...
|---|---|---|---|---|---|
| **auto** | 2026-03-23 08:20 UTC | `c551619` | completedream | appthemanger-ctrl | no file changes<br>Merge pull request #276 from appthemanger-ctrl/copilot/fix-build-issues — fix(build): repair TS cast error in EmbedFeedWidget + revert Instagram to tier3<br> |
