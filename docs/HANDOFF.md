...
|---|---|---|---|---|---|
| **auto** | 2026-04-12 03:07 UTC | `5eece34` | copilot/build-next-js-app-structure | Copilot | +1 added  ~9 modified<br>fix: restore build on copilot/build-next-js-app-structure — runtime bridge, JSX extension, import paths — Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/d983f416-4a0a-4919-81c1-2eb3adcfe597  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>➕: `components/dreamengin/CrossEnginStatusPanel.tsx`<br>✏️: `app/api/security/scan/route.ts`, `components/dreamengin/CrossEnginStatusPanel.ts`, `dreamdmbar/homedream/HomeDream.tsx`, `engins/CodeEngin.tsx`, `engins/GameEngin.tsx`, `engins/StarMakerEngin.tsx`, `engins/portfolio/PortfolioEngin.tsx`, `lib/runtime/dualRuntimeBridge.ts`, `tsconfig.json` |
| **auto** | 2026-04-12 01:49 UTC | `15daf8e` | copilot/build-next-js-app-structure | Copilot | +4 added  ~1 modified<br>feat: add DREAMengin structural self-documentation system — Reasoning: the repo has canonical product structure (surfaces, Dream Windows, Engin runtimes, DreamDM Bar seam) but lacked path aliases and index files to make that structure legible to AI code generators and future contributors who default to generic Next.js patterns (/pages, /widgets, /dashboard, etc.).  Changes: 1. tsconfig.json — added 8 DREAMengin-specific path aliases:    @identity, @identity/*, @dreams/*, @home/*, @daydream/*,    @dreamengin/*, @runtime/*, @agents/*, @structure 2. lib/structure/index.ts — canonical zone map: every app/, components/,    and lib/ zone described with name, path, alias, contains, mustNot.    Includes REJECTED_FOLDER_PATTERNS and ROUTE_RULES for code generators. 3. components/dreams/index.ts — barrel export for all Dream Window layers    (DreamShell, DreamConnectorLayer, DreamFeatureLayer, DreamOutputLayer,    SuperDreamWidget) with usage guide. 4. components/home/index.ts — barrel export for all HomeDream Surface    components with usage guide. 5. lib/identity/index.ts — re-export from canonical-names.ts with full    usage guide; makes @identity the single import point for naming authority.  Architecture justification: docs/ARCHITECTURE.md §3 (logic layer), §4 (Dream Window model), docs/LAW.md rule 10 (repurpose before inventing), docs/AXIOMS.md axiom 2 (cohesive — naming, routing, docs reinforce structure). Performance impact: neutral — structural/type-level changes only.  Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/e1b909d8-22a8-45a9-be4c-5e3a18f5f77a  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>➕: `components/dreams/index.ts`, `components/home/index.ts`, `lib/identity/index.ts`, `lib/structure/index.ts`<br>✏️: `tsconfig.json` |
| **auto** | 2026-04-12 01:41 UTC | `563e03e` | completedream | appthemanger-ctrl | no file changes<br>Merge pull request #472 from appthemanger-ctrl/copilot/remove-unwanted-images — chore: consolidate root-level images into misc/images/<br> |
| **auto** | 2026-04-12 01:25 UTC | `12f74c2` | copilot/remove-unwanted-images | Copilot | +30 added  −30 deleted<br>chore: move all root-level images to misc/images/ — Reasoning: 30 loose image files (social media icons, sprites, logos) were scattered at the repository root with no clear organization. Moving them to misc/images/ follows the stated convention. Architecture justification: asset organization — source/reference images belong in a dedicated directory, not the repo root. Performance impact: neutral  Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/6a80cb15-05a7-4f84-acbe-306ed8fe3832  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>➕: `misc/images/arm2_transparent.png`, `misc/images/boogie3.png`, `misc/images/coat_transparent.png`, `misc/images/discord.png`, `misc/images/dropbox.png`, `misc/images/facebook.png`, `misc/images/figma.png`, `misc/images/head_transparent.png`, `misc/images/iconslist.png`, `misc/images/instagram.png`, `misc/images/linkedin.png`, `misc/images/logo_DREAM_transparent.png` … +18 more<br>🗑️: `arm2_transparent.png`, `boogie3.png`, `coat_transparent.png`, `discord.png`, `dropbox.png`, `facebook.png`, `figma.png`, `head_transparent.png`, `iconslist.png`, `instagram.png`, `linkedin.png`, `logo_DREAM_transparent.png` … +18 more |
