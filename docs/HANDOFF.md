...
|---|---|---|---|---|---|
| **auto** | 2026-04-14 10:15 UTC | `2b265b8` | copilot/fix-wasm-bus-and-build-errors | Copilot | ~1 modified<br>fix: rename VM regions left/right → top/bottom in dualRuntimeBridge — Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/dc4564bc-2091-4bc4-b3ba-631789e39d56  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>✏️: `lib/runtime/dualRuntimeBridge.ts` |
| **auto** | 2026-04-14 08:29 UTC | `e874f00` | copilot/fix-wasm-bus-and-build-errors | Copilot | ~6 modified<br>feat: merge dual VM + quantum compute engine into dualRuntimeBridge — - Add left/right WasmGpuVM instances (lazily via dynamic import) directly to DualRuntimeBridge class - Add inter-VM SharedArrayBuffer ring buffer (256 slots × 1KB) inside DualRuntimeBridge - Inline full QAOA/VQE state-vector quantum circuit engine in dualRuntimeBridge.ts; fires on bridge.emit('lab','quantum:run') → emits 'lab:quantum:result' + writes to inter-VM ring buffer - Export QuantumComputeResult, VMRegion, VMWorkload, 'compute' channel from dualRuntimeBridge - Replace dualVMCoordinator.ts with thin bridge proxy (keeps existing test imports working) - Rewrite PortfolioEngin.tsx: no canvas, no separate component; subscribes to bridge 'lab:quantum:result' and displays real state-vector probabilities and selected assets - Add 'compute' channel to ForgeEngin channel maps in components/daydream and engins  Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/0aa343d3-0a33-492b-888e-9b14942af98c  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>✏️: `components/daydream/ForgeEngin.tsx`, `components/daydream/PortfolioEngin.tsx`, `engins/ForgeEngin.tsx`, `lib/runtime/dualRuntimeBridge.ts`, `lib/vm/dualVMCoordinator.ts`, `lib/vm/index.ts` |
...
| **auto** | 2026-04-14 07:17 UTC | `165133d` | copilot/code-only-request | appthemanger-ctrl | no file changes<br>Merge branch 'completedream' into copilot/code-only-request<br> |
| **auto** | 2026-04-14 07:01 UTC | `42c6b9a` | copilot/code-only-request | Copilot | ~1 modified<br>docs: rewrite dreamengin_phase2.md as Phase 9 Activity-First Protocol integration plan — Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/ab265629-98b6-400e-bf5c-b91afbd843c0  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>✏️: `dreamengin_phase2.md` |
