...
|---|---|---|---|---|---|
| **auto** | 2026-04-14 10:24 UTC | `8d0eb43` | completedream | appthemanger-ctrl | no file changes<br>Merge pull request #522 from appthemanger-ctrl/copilot/fix-wasm-bus-and-build-errors — feat: dual VM (top/bottom) + quantum compute engine merged into DualRuntimeBridge<br> |
