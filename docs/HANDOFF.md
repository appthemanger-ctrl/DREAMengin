...
|---|---|---|---|---|---|
| **auto** | 2026-03-15 14:09 UTC | `8187da4` | copilot/configure-youtube-api-key | Copilot | +1 added  ~6 modified<br>feat: YouTube API key support + trending/world news discovery feed — Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>➕: `app/api/youtube/discovery/route.ts`<br>✏️: `.env.example`, `app/api/connectors/[provider]/connect/route.ts`, `app/api/connectors/[provider]/sync/route.ts`, `app/api/connectors/[provider]/verify/route.ts`, `lib/connectors/connectorRegistry.ts`, `lib/connectors/providers/youtube.ts` |
