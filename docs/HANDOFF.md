...
|---|---|---|---|---|---|
| **auto** | 2026-03-28 05:14 UTC | `901720d` | copilot/improve-website-design-and-functionality | Copilot | ~6 modified<br>feat: SICC visual upgrade — premium gold button glow ring, bar edge shimmer, gradient text, glass entrances, refined auth pages — SICC (Super Immersive Creative Controls) adds a cohesive premium visual layer: - Gold button: breathing glow ring, burst animation on press, enhanced specular highlights - DreamDM Bar: edge shimmer gradient, refined frosted glass, dual-line drag handle - Mode buttons: gradient fill + glow ring animation when active - Send button: shimmer sweep overlay on primary actions - Notification badge: pop entrance animation - Quick compose: focus ring glow + inner shadow depth - WorkspaceDashboard: SICC gradient text hero, glass entrance animations, refined panels - Login/Join: floating ambient glows, gradient wordmark, enhanced dark glass cards - globals.css: 8 new SICC keyframe animations + utility classes (CSS-only, zero JS overhead)  Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/083e57d1-4a4a-4be9-bc86-509fb6f54117  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>✏️: `app/join/page.tsx`, `app/login/page.tsx`, `components/home/WorkspaceDashboard.tsx`, `components/messaging/DreamDMBar.tsx`, `next-env.d.ts`, `styles/globals.css` |
| **auto** | 2026-03-28 04:26 UTC | `1ea85a6` | copilot/improve-website-design-and-functionality | Copilot | ~1 modified<br>chore: drop accidental generated next-env.d.ts change from mobile polish PR — Reasoning: next-env.d.ts was regenerated locally and does not belong in this focused HomeDream mobile UX change.  Architecture justification: keep the PR surgical and limited to the runtime/feed/DreamDM surface changes.  Performance impact: none.  Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/d1298e1b-810f-4ef7-bbb5-3259088c9004  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>✏️: `next-env.d.ts` |
| **auto** | 2026-03-27 23:56 UTC | `b404e87` | completedream | appthemanger-ctrl | no file changes<br>Merge pull request #329 from appthemanger-ctrl/copilot/fix-game-launch-issue — Fix game launch: auto-start games on card click, fix GameRemote ▶ PLAY button<br> |
| **auto** | 2026-03-27 20:17 UTC | `aeacc1c` | copilot/remove-engine-menu-on-play | Copilot | +3 added  ~6 modified<br>fix: launch games directly with shared remote controls — Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/84e8906d-a144-4cf3-81df-0d6b7aeba260  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>➕: `lib/games/navigation.ts`, `lib/games/useGameInputKeyboardBridge.ts`, `tests/game-navigation.test.ts`<br>✏️: `app/daydream/game/page.tsx`, `app/daydream/games/page.tsx`, `app/daydream/play/page.tsx`, `components/daydream/GameEngin.tsx`, `components/games/GameRemote.tsx`, `components/games/GamesHub.tsx` |
| **auto** | 2026-03-27 19:44 UTC | `f504c9c` | completedream | appthemanger-ctrl | no file changes<br>Merge pull request #327 from appthemanger-ctrl/copilot/improve-feed-user-content-display — feat: wire image upload in feed composer, add content type badges, horizontal snap-scroll<br> |
