...
|---|---|---|---|---|---|
| **auto** | 2026-03-20 12:12 UTC | `ee34ff5` | completedream | appthemanger-ctrl | no file changes<br>Merge pull request #254 from appthemanger-ctrl/copilot/add-ai-observability-loop — Add AI-assisted observability and remediation loop to IDARi<br> |
| **auto** | 2026-03-20 10:44 UTC | `820e82e` | completedream | appthemanger-ctrl | no file changes<br>Merge pull request #255 from appthemanger-ctrl/copilot/apply-scaled-down-version-to-project — fix: 7 real product gaps — daydream state persistence, fake DMs, false shop claim, block system, intent execution, triad consensus gate, IDariPanel polling<br> |
| **auto** | 2026-03-20 10:18 UTC | `27c7c05` | copilot/apply-scaled-down-version-to-project | Copilot | +2 added  ~15 modified<br>fix: finish real product gaps — daydream state, demo messages, blocks, intent execution, consensus gate, IDariPanel polling — Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>➕: `app/api/blocks/route.ts`, `supabase/migrations/20260320100000_user_blocks.sql`<br>✏️: `app/api/ai/execute/route.ts`, `app/daydream/brand/page.tsx`, `app/daydream/code/page.tsx`, `app/daydream/create/page.tsx`, `app/daydream/games/page.tsx`, `app/daydream/lab/page.tsx`, `app/daydream/music/page.tsx`, `app/settings/privacy/PrivacyClient.tsx`, `app/shop/page.tsx`, `components/IDariPanel.tsx`, `components/MessagesClient.tsx`, `components/daydream/DaydreamShell.tsx` … +3 more |
