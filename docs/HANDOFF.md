...
| **auto** | 2026-04-13 00:55 UTC | `2b7f4be` | copilot/improve-game-engine-integration | Copilot | +6 added  ~2 modified<br>feat: implement Game Cartridge Runtime architecture — - Create lib/gameengin/cartridge.ts with GameCartridge, GameEngineAPI interfaces - Create lib/gameengin/GameRuntime.tsx with shared fixed-timestep RAF loop - Create lib/gameengin/ReactComponentCartridge.ts backward compat adapter - Create games/tetris/TetrisCartridge.ts (uses api.loop, api.physics.gravity, api.input, api.score) - Create games/snake/SnakeCartridge.ts (friction affects speed, api.input, api.score) - Update engins/GameEngin.tsx to use GameRuntime with cartridge map - Update lib/gameengin/index.ts to export new modules - Add tests/game-cartridge-runtime.test.ts (16 pass, 2 skipped for DOM)  Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/cc8ee79e-21b8-4e23-b82b-aa2a9ab6d721  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>➕: `games/snake/SnakeCartridge.ts`, `games/tetris/TetrisCartridge.ts`, `lib/gameengin/GameRuntime.tsx`, `lib/gameengin/ReactComponentCartridge.ts`, `lib/gameengin/cartridge.ts`, `tests/game-cartridge-runtime.test.ts`<br>✏️: `engins/GameEngin.tsx`, `lib/gameengin/index.ts` |
| **auto** | 2026-04-13 00:35 UTC | `5d68f46` | completedream | appthemanger-ctrl | no file changes<br>Merge pull request #495 from appthemanger-ctrl/claude/fix-home-page-content-issue — fix: redirect authenticated users from landing page to home feed<br> |
| **auto** | 2026-04-12 19:37 UTC | `f0788d7` | claude/fix-home-page-content-issue | Claude | ~1 modified<br>fix: redirect authenticated users from landing page to home feed — - Add auth check to root page (app/page.tsx) - Redirect authenticated users to /homedream where feed content lives - Maintain landing page for unauthenticated visitors - Fixes issue where logged-in users saw empty landing page instead of feed  Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/2cf9b201-4589-424e-90a7-4ec9310a6278  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>✏️: `app/page.tsx` |
