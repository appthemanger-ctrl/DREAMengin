...
|---|---|---|---|---|---|
| **auto** | 2026-04-13 01:23 UTC | `f61ff7e` | claude/update-dreamdm-bar-component | appthemanger-ctrl | no file changes<br>Merge branch 'completedream' into claude/update-dreamdm-bar-component<br> |
| **auto** | 2026-04-13 00:58 UTC | `ec5f5b9` | claude/update-dreamdm-bar-component | Claude | −1 deleted  ~9 modified<br>refactor: consolidate DreamDMBar to canonical dreamdmbar/ location — Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/8b4990ef-05df-4d6e-8fdf-2ab3510d348e  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>✏️: `CHANGELOG.md`, `README.md`, `build-memory/events.json`, `build-memory/ui-surfaces.json`, `docs/GOLD_BUTTON_DUAL_RUNTIME.md`, `docs/GOLD_BUTTON_QUICK_REF.md`, `docs/dreamdm_messaging_phase2.md`, `tests/home-feed-home.test.ts`, `tests/v2-readiness.test.ts`<br>🗑️: `components/messaging/DreamDMBar.tsx` |
