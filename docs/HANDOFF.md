...
|---|---|---|---|---|---|
| **auto** | 2026-04-12 17:30 UTC | `7abf4d9` | copilot/improve-dreamr-social-media | Copilot | ~3 modified<br>fix: address code review — fix double json() bug, extract magic numbers, normalize count display — Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/6aaebbb0-b28c-4d8c-bce6-d65ae3f6b57f  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>✏️: `components/FeedCard.tsx`, `components/dreamr/DreamRSection.tsx`, `components/feed/CommentSection.tsx` |
| **auto** | 2026-04-12 17:28 UTC | `2ba7e12` | copilot/improve-dreamr-social-media | Copilot | ~5 modified<br>feat: real UX improvements — fix like toggle, save, follow, inline comments, draft persistence, error feedback — Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/6aaebbb0-b28c-4d8c-bce6-d65ae3f6b57f  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>✏️: `components/FeedCard.tsx`, `components/dreamr/DreamRSection.tsx`, `components/feed/CommentSection.tsx`, `dreamdmbar/homedream/dreamr/DreamRCreatorPanel.tsx`, `dreamdmbar/homedream/dreamr/algorithms/dreamrfeed.tsx` |
| **auto** | 2026-04-12 17:01 UTC | `1557959` | completedream | appthemanger-ctrl | no file changes<br>Merge pull request #485 from appthemanger-ctrl/copilot/improve-ui-visualization — feat(ui): hyper-polish — DreamConstellationMap, JourneyTrail, DreamsSpacePanel, DREAMenginOS<br> |
| **auto** | 2026-04-12 16:56 UTC | `3c4b4c7` | copilot/improve-ui-visualization | Copilot | ~3 modified<br>fix: DreamDMBar input cut in half — DIVIDER_H 80→108, no safe-area padding in divider mode — Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/e57fd84c-1e47-4f19-8b7f-82e623072101  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>✏️: `components/messaging/DreamDMBar.tsx`, `dreamdmbar/DreamDMBar.tsx`, `lib/dreamdm/barInteractions.ts` |
| **auto** | 2026-04-12 11:06 UTC | `275abd5` | copilot/improve-ui-visualization | Copilot | ~4 modified<br>feat(ui): hyper-polish — starfield+trails+rings in constellation, sparkline+glow in journey, animated glass+barchart in DreamsSpace, color-coded HUD in OS — DreamConstellationMap: - Add 120-star static twinkle starfield behind all motes - Spark trails: each edge spark now draws 3 fading ghost positions - Ring pulse animation radiates outward from every node on staggered timers - Node halos boosted: saturation/alpha doubled, 4-stop radial gradient - Touch support: touchmove hover + touchend tap-to-navigate for mobile  JourneyTrail: - Framer-motion pulsing glow ring for significance >= 0.9 dots (scale+boxShadow animate) - AnimatePresence smooth height:auto expand/collapse for dot detail rows - SparklineBar: 7-day activity bar chart derived from dots[] under streak banner - Vertical thread changed to gold→dim linear-gradient  DreamsSpacePanel: - Framer-motion AnimatePresence mode='wait' for Apps/Feeds tab transitions (fade+slide) - EngineBarChart: animated horizontal bar chart for 'engines used today' in Forge Analytics - All 4 stats cards upgraded to dark glass (rgba(8,16,38,0.52) + saturate(180%) blur) - Daydreams/Engin section containers upgraded to deep dark glass  DREAMenginOS: - Status indicator: expanding pulse ring behind status dot, split HUD text - Subsystem family cards: color-coded per ORB_COLORS with gradient left-border - Runtime telemetry: labeled data cards with accent colors per metric - Connected runtimes header: decorative gold gradient rule  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>✏️: `components/daydream/DreamConstellationMap.tsx`, `components/daydream/JourneyTrail.tsx`, `components/dreamengin/DREAMenginOS.tsx`, `components/dreams/DreamsSpacePanel.tsx` |
