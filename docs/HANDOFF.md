...
|---|---|---|---|---|---|
| **auto** | 2026-03-29 07:01 UTC | `fbee457` | claude/integrate-dualsense-controller | Claude | +3 added  ~2 modified<br>feat: integrate DualSense controller support with mobile Bluetooth, haptics, and gyro — - Add DualSenseManager class with full state access (lib/games/DualSenseManager.ts) - Enhance useGamepad hook with isDualSense detection and rumble function - Update GameEngin to expose rumble globally and show DualSense badge - Support mobile Bluetooth pairing (Android 12+, iOS 14.5+) - Add haptic feedback API with intensity and duration controls - Include gyroscope support for mobile tilt steering/aiming - Maintain backward compatibility with existing game input system - Add comprehensive documentation and testing guides  Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/9059ed00-5560-48e0-ac20-af378e0833b8  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>➕: `docs/DUALSENSE_INTEGRATION.md`, `lib/games/DualSenseManager.ts`, `tests/DUALSENSE_TEST_PLAN.md`<br>✏️: `components/daydream/GameEngin.tsx`, `lib/games/useGamepad.ts` |
...
| **auto** | 2026-03-29 05:23 UTC | `d730e21` | copilot/add-ai-agent-for-game-building | Copilot | +4 added  −2 deleted  ~2 modified<br>feat: add report-driven GitHub coding agent workflow — Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/71389f1f-3d06-49b6-a608-42ca696eec43  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>➕: `.github/scripts/ai_report_propose.py`, `.github/scripts/assemble_report_context.py`, `.github/workflows/report-driven-coding-agent.yml`, `docs/GITHUB_CODING_AGENT.md`<br>✏️: `components/daydream/GameEngin.tsx`, `docs/AGENT_PLAYBOOK.md`<br>🗑️: `app/api/ai/game-builder/route.ts`, `components/games/GameBuilderAgent.tsx` |
