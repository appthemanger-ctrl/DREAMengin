...
|---|---|---|---|---|---|
| **auto** | 2026-03-28 06:57 UTC | `89c0be0` | completedream | appthemanger-ctrl | +1 added<br>Create gameengin.agent.md template for custom agents — Added a template for creating a custom agent.<br>➕: `.github/agents/gameengin.agent.md` |
