...
|---|---|---|---|---|---|
| **auto** | 2026-04-05 07:07 UTC | `765473c` | copilot/create-code-dream-engine | Copilot | ~2 modified<br>fix: use handleRunRef pattern to avoid stale closures in live-mode debounce — Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/4c7571bb-0978-4811-a6da-e0dabc2f00e5  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>✏️: `components/daydream/CodeDreamIDE.tsx`, `components/daydream/LabDreamIDE.tsx` |
| **auto** | 2026-04-05 07:01 UTC | `682e483` | copilot/create-code-dream-engine | Copilot | +1 added  ~3 modified<br>feat: add live split swap to CodeDreamIDE and LabDreamIDE with bridge events — Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/4c7571bb-0978-4811-a6da-e0dabc2f00e5  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>➕: `lib/runtime/swapManager.ts`<br>✏️: `components/daydream/CodeDreamIDE.tsx`, `components/daydream/LabDreamIDE.tsx`, `lib/runtime/dualRuntimeBridge.ts` |
