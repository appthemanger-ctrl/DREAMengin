...
| **auto** | 2026-03-16 03:29 UTC | `a5117a8` | completedream | appthemanger-ctrl | no file changes<br>Merge pull request #219 from appthemanger-ctrl/copilot/update-readme-md — docs: comprehensive README.md audit and fix<br> |
| **auto** | 2026-03-16 02:33 UTC | `919299c` | copilot/fix-home-button-dual-menus | Copilot | +2 added  ~3 modified<br>fix: make DreamDMBar global, remove secondary bar from edit-profile — - Add DreamSystemContext with global dual-menu and DrEams panel state - Add GlobalDreamBar rendered in root layout so DreamDMBar persists on all surfaces - HomeSystem registers runtime callbacks (blend/mode/returnHome) via context - Edit-profile: remove position:sticky from header (no more secondary fixed bar) - Build: ✓ (48 routes), Tests: ✓ (832/832), CodeQL: ✓ (0 alerts)  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>➕: `components/home/GlobalDreamBar.tsx`, `lib/dreamdm/DreamSystemContext.tsx`<br>✏️: `app/edit-profiledream/page.tsx`, `app/layout.tsx`, `components/home/HomeSystem.tsx` |
