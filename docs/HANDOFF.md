...
|---|---|---|---|---|---|
| **auto** | 2026-03-19 14:29 UTC | `b3fbf48` | copilot/add-user-sim-ai-agent | Copilot | ~1 modified<br>fix: restore probabilistic distracted-persona pause (revert deterministic % 3 hack) — Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>✏️: `lib/user-sim/userSimAgent.ts` |
