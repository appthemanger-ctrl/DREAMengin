...
|---|---|---|---|---|---|
| **auto** | 2026-03-30 18:22 UTC | `a684f16` | copilot/wire-games-to-new-game-engine | Copilot | +6 added  ~3 modified<br>feat: add authored MADMAXI zone starter packs — Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/6c706b4c-f863-4327-98ae-14bdade9e107  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>➕: `components/games/madmaxi/audio.ts`, `components/games/madmaxi/authoredZonePacks.ts`, `components/games/madmaxi/config.ts`, `components/games/madmaxi/levels.ts`, `components/games/madmaxi/types.ts`, `tests/madmaxi-authored-levels.test.ts`<br>✏️: `components/games/BabylonSideScroller.tsx`, `components/games/madmaxi/MadmaxiGame.tsx`, `components/games/madmaxi/index.ts` |
| **auto** | 2026-03-30 15:55 UTC | `5441716` | copilot/wire-games-to-new-game-engine | Copilot | ~3 modified<br>feat: MADMAXI robot hero + 10-coin mechanic + catalog rebrand complete — Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/fcd730ca-6aba-4ec5-b69a-a44cd348150b  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>✏️: `app/daydream/games/page.tsx`, `components/games/BabylonSideScroller.tsx`, `tests/game-navigation.test.ts` |
