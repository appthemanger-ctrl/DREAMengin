...
|---|---|---|---|---|---|
| **auto** | 2026-04-06 10:41 UTC | `b742e7a` | copilot/sync-supabase-and-completedream | Copilot | ~1 modified<br>fix: make SQL migration guard auto-sync on completedream only — Reasoning: remove the mistaken scheduled sync path and keep Supabase reconciliation automatic on completedream push activity while preserving PR guard scans. Architecture justification: docs/ARCHITECTURE.md §10 keeps Supabase workflow assumptions stable around the repo's primary sync branch. Performance impact: none.  Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/18048d8f-1cc9-4a91-96f0-ce38b6b5775d  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>✏️: `.github/workflows/sql-migration-guard.yml` |
