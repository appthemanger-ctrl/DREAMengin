...
|---|---|---|---|---|---|
| **auto** | 2026-03-26 07:15 UTC | `78fe2d3` | copilot/build-perfected-dreamwars-and-engin-battle | Copilot | +3 added  ~4 modified<br>feat: integrate GSAP for UI transitions and card entrance animations — Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com> Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/87f7665a-0c18-4391-be57-19347a997f7c<br>➕: `lib/gsap/gsap.ts`, `lib/gsap/useGsapEntrance.ts`, `lib/gsap/useGsapFlip.ts`<br>✏️: `app/dream-effects/page.tsx`, `components/daydream/DaydreamShell.tsx`, `components/games/GamesHub.tsx`, `package.json` |
