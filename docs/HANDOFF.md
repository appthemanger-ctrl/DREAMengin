...
|---|---|---|---|---|---|
| **auto** | 2026-04-04 06:51 UTC | `c7ac412` | copilot/add-webgpu-compute-shader-pipeline | Copilot | +8 added  ~1 modified<br>test: add 105 tests for Phase 9 features — offline cache, scene state, adaptive quality, gestures, drag-drop, notifications, hashtags, cross-post — Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/2b87ca29-ba97-4d67-9387-98e111ad58f3  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>➕: `tests/phase9-adaptive-quality.test.ts`, `tests/phase9-cross-post.test.ts`, `tests/phase9-drag-drop.test.ts`, `tests/phase9-hashtags.test.ts`, `tests/phase9-notifications.test.ts`, `tests/phase9-offline-cache.test.ts`, `tests/phase9-scene-state.test.ts`, `tests/phase9-touch-gestures.test.ts`<br>✏️: `lib/offline/offlineCache.ts` |
...
| **auto** | 2026-04-03 12:27 UTC | `e6c4f3e` | copilot/modernize-game-controls-layout | Copilot | ~6 modified<br>feat: draggable DM bar orb, landscape game layout, wider joysticks, MADMAXI speed tuning + soundtrack — - DreamDMBar minimized orb: now draggable with tap-to-restore and drag-to-reposition - ImmersiveGameShell: landscape-aware viewport clearance (clamp instead of fixed 38dvh) - MobileGameHUD: landscape CSS overrides for compact controls, dismissable +/- pill - MobileGameHUD: joystick travel radius increased from 30% to 45%, cap travel from 34% to 50% - MADMAXI: walk speed reduced 15% (0.115 → 0.098), jump velocity reduced 15% (0.68 → 0.578) - MADMAXI: dash speed reduced 15% (0.42 → 0.357), gravity and fall speed unchanged - MADMAXI audio: added continuous procedural BGM with bass drone, arpeggio, and rhythm layers  Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/a5c8d6b0-cf05-4a90-b4f0-462a8c1240a4  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>✏️: `app/daydream/game/ImmersiveGameShell.tsx`, `components/games/MobileGameHUD.module.css`, `components/games/MobileGameHUD.tsx`, `components/games/madmaxi/MadmaxiGame.tsx`, `components/games/madmaxi/audio.ts`, `components/messaging/DreamDMBar.tsx` |
