...
|---|---|---|---|---|---|
| **auto** | 2026-04-12 08:11 UTC | `c757843` | completedream | appthemanger-ctrl | no file changes<br>Merge pull request #481 from appthemanger-ctrl/copilot/update-engin-workflows-md — feat: Engin Workflows — spec + pure engine library + React hook + 35 tests<br> |
| **auto** | 2026-04-12 08:06 UTC | `dd2889a` | copilot/update-engin-workflows-md | Copilot | +4 added<br>feat: add engin_workflows spec and core workflow engine library — Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/270d9e1a-f083-4cff-a130-cb348407a5f3  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>➕: `docs/engin_workflows.md`, `lib/engins/useEnginWorkflow.ts`, `lib/engins/workflowEngine.ts`, `tests/engin-workflow.test.ts` |
