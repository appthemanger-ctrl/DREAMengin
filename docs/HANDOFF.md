...
|---|---|---|---|---|---|
| **auto** | 2026-04-12 17:36 UTC | `896f6ad` | completedream | appthemanger-ctrl | no file changes<br>Merge pull request #487 from appthemanger-ctrl/copilot/improve-app-functionality-by-100 — feat: 100 functional improvements — utils, runtime, observability, offline queue, IDARi loop<br> |
| **auto** | 2026-04-12 17:34 UTC | `09d5117` | copilot/improve-app-functionality-by-100 | appthemanger-ctrl | no file changes<br>Merge branch 'completedream' into copilot/improve-app-functionality-by-100<br> |
| **auto** | 2026-04-12 17:27 UTC | `b88ecdb` | copilot/improve-app-functionality-by-100 | Copilot | +9 added  ~15 modified<br>feat: 100 non-cosmetic functional improvements across DREAMengin subsystems — Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/738f831b-c36d-4457-bd89-aa7d1d4e3b5a  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>➕: `lib/observability/healthTrend.ts`, `lib/runtime/channelMetrics.ts`, `lib/runtime/offlineQueue.ts`, `lib/runtime/snapshotFingerprint.ts`, `tests/collector-extended.test.ts`, `tests/data-transform-extended.test.ts`, `tests/offline-queue.test.ts`, `tests/swap-manager-extended.test.ts`, `tests/utils-extended.test.ts`<br>✏️: `lib/agents/idariLoop.ts`, `lib/assets/indexedDBStore.ts`, `lib/data-transform.ts`, `lib/dreamdm/useDreamDMDraft.ts`, `lib/dreamdm/useNotifications.ts`, `lib/observability/collector.ts`, `lib/observability/correlator.ts`, `lib/runtime/dreamOSBus.ts`, `lib/runtime/dualRuntimeBridge.ts`, `lib/runtime/enginWorkflowRegistry.ts`, `lib/runtime/memory.ts`, `lib/runtime/seamClipboard.ts` … +3 more |
| **auto** | 2026-04-12 16:37 UTC | `c778aa4` | copilot/skip-vercel-build-step | Copilot | ~3 modified<br>fix: correct prevPropSubsystemRef usage, guard division-by-zero, badge text 'WARM DEFAULTS' — Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/da55ea3f-bfe2-4640-8342-d913521c576e  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>✏️: `components/dreamengin/DREAMenginOS.tsx`, `lib/intelligence/sessionPatternEngine.ts`, `lib/intelligence/useSessionIntelligence.ts` |
| **auto** | 2026-04-12 16:35 UTC | `859edd8` | copilot/skip-vercel-build-step | Copilot | ~4 modified<br>feat(intelligence): enforce all five dimensions — cold-start defaults, matrix persistence, bus auto-ingest, Dr. Eams panel — Agent-Logs-Url: https://github.com/appthemanger-ctrl/DREAMengin/sessions/da55ea3f-bfe2-4640-8342-d913521c576e  Co-authored-by: appthemanger-ctrl <253588904+appthemanger-ctrl@users.noreply.github.com><br>✏️: `components/dreamengin/DREAMenginOS.tsx`, `lib/intelligence/sessionPatternEngine.ts`, `lib/intelligence/useSessionIntelligence.ts`, `tests/session-pattern-engine.test.ts` |
