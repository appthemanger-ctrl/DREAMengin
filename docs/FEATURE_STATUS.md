...
12. ✅ Repurpose legacy Daydream routes (`analytics`, `media-vault`, `play`) — done. Each redirects to its canonical Daydream Surface: analytics → /daydream/brand, media-vault → /daydream/create, play → /daydream/games.
