/**
 * components/dream.HomeRadialNav.tsx — DEPRECATED / REDIRECTED
 *
 ...
 *   components/menus/dream.menu.DreamRadialMenu.tsx   ← Daydream navigation (left menu)
 *   components/menus/dream.menu.SystemRadialMenu.tsx  ← System navigation (right menu)
 *   components/menus/dream.menu.DualBottomMenu.tsx    ← Unified bottom menu wrapper (both)
 *
 ...
 *     components/menus/dream.menu.DreamRadialMenu.tsx (canonical)
...
export { default } from '@/components/menus/dream.menu.DreamRadialMenu';
