...
export default function DrEamsVoiceAssistant() {
  ...
  const getSmartResponse = (query: string): string => {
    ...
    if (lowerQuery.includes('post') || lowerQuery.includes('create')) {
      ...
      return 'Your profile is your creative hub on DREAMengin! Open Edit ProfileDream to customize everything about your presence. You can update your bio, change your avatar, select a theme, showcase your music, display merchandise, and highlight your lab projects. Think of it as your personal portfolio that tells your story!';
    } else if (lowerQuery.includes('ad') || lowerQuery.includes('monetize')) {
      return 'Monetization is one of the most powerful features here! DreamAds lets you create your own ad slots on your profile and set your own pricing — these are user-owned spaces, not platform ads. You manage bookings, track performance, and revenue sharing is built right in. Head to DreamAds to get started. Many creators find this to be a great passive income stream!';
