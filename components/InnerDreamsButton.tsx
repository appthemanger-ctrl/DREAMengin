...
export default function IdariButton({ isAdmin }: IdariButtonProps) {
  ...
  return (
    <button
      ...
      className="fixed bottom-24 right-6 bg-gradient-to-r from-[#2a8ab8] to-[#c8981a] text-white p-3 rounded-full shadow-lg hover:shadow-xl transition-all hover:scale-110 z-40 group"
      aria-label="Open iDari Admin Panel"
      title="iDari — Inner Dreams AI"
    >
