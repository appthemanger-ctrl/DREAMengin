...
const JUMP_VY    = 0.578;   // initial jump Y velocity (tuned down ~15% for tighter control)
const WALK_SPD   = 0.098;   // horizontal speed (tuned down ~15% for precise movement)
const COYOTE_MS  = 8;       // extra frames to jump after leaving ledge
const JBUF_MS    = 6;       // frames to buffer a jump before landing
const DASH_SPD   = 0.357;   // player dash speed (≈ 3.6× walk, tuned down ~15%)
