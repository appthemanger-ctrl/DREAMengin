...
export default function Idari({ userId, isAdmin }: IdariProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-sky-50 to-blue-50 dark:from-sky-900/20 dark:to-blue-900/20 rounded-xl border-2 border-sky-200 dark:border-sky-700 p-6">
      {/* Header */}
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-gradient-to-r from-[#2a8ab8] to-[#c8981a] rounded-lg">
            <Sparkles className="w-6 h-6 text-white" />
          </div>
          <div>
            <h3 className="text-xl font-bold text-slate-900 dark:text-white">iDari</h3>
            <p className="text-sm text-slate-600 dark:text-slate-400">Inner Dreams AI — Auto-Updater &amp; Bug Monitor</p>
          </div>
        </div>
        <button
      ...
      <div className="space-y-4 mb-6">
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500 dark:bg-slate-800 dark:text-white resize-none"
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 bg-gradient-to-r from-[#2a8ab8] to-[#c8981a] text-white px-6 py-2 rounded-lg hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-all font-medium"
          >
