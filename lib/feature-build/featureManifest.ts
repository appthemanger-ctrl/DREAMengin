...
const GAMES_MANIFEST: DaydreamEnginManifest = {
  ...
  features: [
    ...
    { id: 'game-remote',         label: 'Universal Game HUD',    description: 'Engine-owned fullscreen HUD controller',     status: 'implemented', detectPattern: 'GameHUD',               detectPaths: ['engins/engin.GameEngin.tsx'] },
...
const LAB_MANIFEST: DaydreamEnginManifest = {
  ...
  features: [
    ...
    { id: 'quantum-circuit',     label: 'Quantum Circuit Canvas', description: 'Real QAOA / VQE quantum circuit simulator (shared engin component)', status: 'implemented', detectPattern: 'QuantumCircuitCanvas',  detectPaths: ['engins/dream.engin.QuantumCircuitCanvas.tsx', 'engins/engin.LabEngin.tsx', 'engins/portfolio/engin.PortfolioEngin.tsx'] },
