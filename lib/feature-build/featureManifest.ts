...
const LAB_MANIFEST: DaydreamEnginManifest = {
  ...
  features: [
    ...
    { id: 'quantum-circuit',     label: 'Quantum Circuit Canvas', description: 'Real QAOA / VQE quantum circuit simulator (shared engin component)', status: 'implemented', detectPattern: 'QuantumCircuitCanvas',  detectPaths: ['engins/dream.QuantumCircuitCanvas.tsx', 'engins/engin.LabEngin.tsx', 'engins/portfolio/engin.PortfolioEngin.tsx'] },
