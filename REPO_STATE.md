...
**Last Updated:** 4/15/2026, 5:55:06 AM
**Branch:** copilot/request-engine-codes
**Commit:** 65e48856 - Merge remote-tracking branch 'origin/completedream' into copilot/request-engine-codes
**Total Commits:** 4504
...
- 📁 Total Code Files: 714
- 📝 Total Lines of Code: 174,660
- 📦 Size: 6.55 MB
- 🧪 Tests: 149 files, 153 passing
- 📄 API Routes: 97
...
|-----------|-------------|------------|
| `app/` | 224 | .tsx(125), .ts(97), .css(2) |
| `components/` | 305 | .tsx(278), .ts(24), .css(2) |
| `lib/` | 315 | .ts(306), .tsx(5), .md(3) |
| `tests/` | 151 | .ts(150), .md(1) |
| `styles/` | 5 | .css(5) |
