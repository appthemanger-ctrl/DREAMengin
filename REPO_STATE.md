...
**Documentation Date:** 2026-05-11
**Last Updated:** 5/11/2026, 3:25:51 AM
**Branch:** completedream
**Commit:** ac40c856 - Merge pull request #752 from appthemanger-ctrl/copilot/fix-landing-page-background
**Total Commits:** 5350
...
- 📁 Total Code Files: 820
- 📝 Total Lines of Code: 166,392
- 📦 Size: 5.97 MB
- 🧪 Tests: 201 files, 195 passing
- 📄 API Routes: 107
- 🎨 Components: 42 categories
- 📖 Documentation: 96 files
- ⚙️ GitHub Actions: 55 workflows
...
|-----------|-------------|------------|
| `app/` | 239 | .tsx(130), .ts(108), .css(1) |
| `components/` | 298 | .tsx(263), .ts(32), .css(2) |
| `lib/` | 516 | .ts(419), .json(67), .md(21) |
| `tests/` | 202 | .ts(201), .md(1) |
| `styles/` | 5 | .css(5) |
| `public/` | 34 | .png(12), .svg(5), .json(4) |
| `docs/` | 94 | .md(93), no-extension(1) |
...
- [ENGIN_RUNTIME.md](/docs/ENGIN_RUNTIME.md)
