...
**Last Updated:** 4/12/2026, 2:03:18 AM
**Branch:** copilot/fix-build-log-errors-another-one
**Commit:** 160c2aeb - Merge branch 'completedream' into copilot/fix-build-log-errors-another-one
**Total Commits:** 3632
...
- 📁 Total Code Files: 664
- 📝 Total Lines of Code: 163,270
- 📦 Size: 6.20 MB
- 🧪 Tests: 130 files, 120 passing
- 📄 API Routes: 89
...
| `components/` | 297 | .tsx(270), .ts(24), .css(2) |
| `lib/` | 270 | .ts(264), .tsx(4), .md(2) |
| `tests/` | 133 | .ts(132), .md(1) |
| `styles/` | 3 | .css(3) |
