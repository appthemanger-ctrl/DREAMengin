...
**Last Updated:** 4/6/2026, 5:36:05 AM
**Branch:** copilot/fix-syntax-error-expectation
**Commit:** 996829a7 - docs: auto-update BUGS.md [197b365] [skip ci] [skip vercel]
**Total Commits:** 2
...
- 📁 Total Code Files: 653
- 📝 Total Lines of Code: 165,025
- 📦 Size: 6.28 MB
- 🧪 Tests: 125 files, 119 passing
- 📄 API Routes: 86
...
| `components/` | 294 | .tsx(268), .ts(23), .css(2) |
| `lib/` | 261 | .ts(256), .tsx(3), .md(2) |
| `tests/` | 127 | .ts(126), .md(1) |
| `styles/` | 3 | .css(3) |
