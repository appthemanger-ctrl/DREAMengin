...
**Last Updated:** 4/12/2026, 1:48:28 AM
**Branch:** copilot/fix-github-actions-updating-docs
**Commit:** 495eaa69 - Merge branch 'completedream' into copilot/fix-github-actions-updating-docs
**Total Commits:** 3619
...
- 📝 Total Lines of Code: 164,135
- 📦 Size: 6.25 MB
- 🧪 Tests: 130 files, 116 passing
- 📄 API Routes: 89
...
| `components/` | 297 | .tsx(269), .ts(25), .css(2) |
| `lib/` | 270 | .ts(265), .tsx(3), .md(2) |
