...
**Last Updated:** 4/20/2026, 4:59:45 PM
**Branch:** completedream
**Commit:** 6ad1cd2c - chore: sync build-memory [skip ci] [skip vercel]
**Total Commits:** 4995
...
- 📁 Total Code Files: 781
- 📝 Total Lines of Code: 164,243
- 📦 Size: 5.90 MB
- 🧪 Tests: 181 files, 175 passing
- 📄 API Routes: 99
...
| `components/` | 295 | .tsx(263), .ts(29), .css(2) |
| `lib/` | 478 | .ts(382), .json(67), .md(21) |
| `tests/` | 182 | .ts(181), .md(1) |
| `styles/` | 5 | .css(5) |
