...
**Last Updated:** 4/20/2026, 10:11:55 AM
**Branch:** completedream
**Commit:** d537cb35 - chore: sync build-memory [skip ci] [skip vercel]
**Total Commits:** 4978
...
- 📁 Total Code Files: 793
- 📝 Total Lines of Code: 167,977
- 📦 Size: 6.05 MB
- 🧪 Tests: 179 files, 173 passing
- 📄 API Routes: 99
...
| `components/` | 307 | .tsx(275), .ts(29), .css(2) |
| `lib/` | 478 | .ts(382), .json(67), .md(21) |
| `tests/` | 180 | .ts(179), .md(1) |
| `styles/` | 5 | .css(5) |
