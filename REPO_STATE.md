...
**Last Updated:** 4/1/2026, 4:38:12 AM
**Branch:** completedream
**Commit:** 2efb3954 - docs: auto-update README [1bf40f6] [skip ci]
**Total Commits:** 2743
...
- 📁 Total Code Files: 574
- 📝 Total Lines of Code: 130,645
- 📦 Size: 4.93 MB
- 🧪 Tests: 84 files, 77 passing
- 📄 API Routes: 71
...
|-----------|-------------|------------|
| `app/` | 197 | .tsx(123), .ts(72), .css(2) |
| `components/` | 270 | .tsx(245), .ts(22), .css(2) |
| `lib/` | 208 | .ts(203), .tsx(3), .md(2) |
| `tests/` | 86 | .ts(85), .md(1) |
| `styles/` | 3 | .css(3) |
