...
|---|---|---|---|---|---|
| `da894ba` | 2026-04-01 20:27 UTC | copilot/improve-dependencies-usage | Copilot | +3 ~3 | feat: full dependency enhancement - GSAP scroll reveal, framer-motion 3D tilt, AI Director hook, Drei sparkles/float/trail |
...
Last updated: 2026-04-01 20:27 UTC — `da894ba` by Copilot
