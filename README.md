...
<!-- Last regenerated: 2026-04-06 10:03 UTC — `847b6b5` on `copilot/update-readme-dreamengin-spec` -->

> **Documentation Owner:** José Mancilla (appthemanger-ctrl)  
> **Documentation Date:** 2026-04-06 10:03 UTC
...
| `tests/` | Vitest test suite (123 test files) |
...
| Routes | ~189 (102 pages + 87 API handlers) |
| Test files | 123 |
| Last push | `847b6b5` by **github-actions[bot]** on `copilot/update-readme-dreamengin-spec` |
| Timestamp | 2026-04-06 10:03 UTC |
...
<!-- DREAMENGIN-SPEC-SNAPSHOT:START -->
...
- **Canonical main branch:** `completedream`
...
- `completedream` is the canonical main branch and the branch Idari should treat as the primary merge target for spec freshness.
...
<!-- DREAMENGIN-SPEC-SNAPSHOT:END -->

## Recent Changes

| Revision | Date / Time (UTC) | Branch | Author | Files | Summary |
|---|---|---|---|---|---|
| `847b6b5` | 2026-04-06 10:03 UTC | copilot/update-readme-dreamengin-spec | github-actions[bot] | ~1 | docs: auto-update HANDOFF timeline [da23f08] [skip ci] [skip vercel] |
| `7d5f199` | 2026-04-06 10:01 UTC | copilot/update-readme-dreamengin-spec | copilot-swe-agent[bot] | ~3 | docs: refresh README spec snapshot and merge automation |
| `996829a` | 2026-04-06 05:16 UTC | copilot/fix-syntax-error-expectation | copilot-swe-agent[bot] | ~1 | docs: auto-update BUGS.md [197b365] [skip ci] [skip vercel] |
| `71b0f9b` | 2026-04-06 03:24 UTC | copilot/fix-syntax-error-expectation | copilot-swe-agent[bot] | ~1 | docs: auto-update BUGS.md [bffb861] [skip ci] [skip vercel] |
| `b0c3f67` | 2026-04-05 07:53 UTC | copilot/update-readme-md-again | copilot-swe-agent[bot] | ~1 | docs: auto-update REPO_STATE.md [skip ci] [skip vercel] |
| `b0c3f67` | 2026-04-05 07:53 UTC | copilot/update-readme-md-again | copilot-swe-agent[bot] | ~1 | docs: auto-update REPO_STATE.md [skip ci] [skip vercel] |
| `936b5ff` | 2026-04-03 12:39 UTC | completedream | appthemanger-ctrl | — | Merge pull request #418 from appthemanger-ctrl/copilot/integrate-everything |
| `17e3ed6` | 2026-04-03 12:39 UTC | copilot/integrate-everything | appthemanger-ctrl | — | Merge branch 'completedream' into copilot/integrate-everything |
| `e1cf998` | 2026-04-03 12:37 UTC | completedream | appthemanger-ctrl | — | Merge pull request #419 from appthemanger-ctrl/copilot/improve-game-controls-and-ui |
| `6d506fc` | 2026-04-03 12:30 UTC | copilot/improve-game-controls-and-ui | Copilot | ~2 | Address review feedback: proper tap-toggle for drag handle, remove unused bgmOscillators array |


---

## Current Implementation Status
Last updated: 2026-04-06 10:03 UTC — `847b6b5` by github-actions[bot]
...
Build Status: 189 routes (102 pages + 87 API handlers) · 123 test files
