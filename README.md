...
<!-- Last regenerated: 2026-04-02 07:04 UTC — `6811ff2` on `copilot/modernize-all-games-graphics-performance` -->
<!-- Last regenerated: 2026-04-02 07:40 UTC — `a2ba14c` on `completedream` -->
...
| `tests/` | Vitest test suite (82 test files) |
...
| Routes | ~174 (100 pages + 74 API handlers) |
| Test files | 82 |
| Last push | `6811ff2` by **Copilot** on `copilot/modernize-all-games-graphics-performance` |
| Timestamp | 2026-04-02 07:04 UTC |
| Test files | 81 |
| Last push | `a2ba14c` by **appthemanger-ctrl** on `completedream` |
| Timestamp | 2026-04-02 07:40 UTC |
...
|---|---|---|---|---|---|
| `6811ff2` | 2026-04-02 07:04 UTC | copilot/modernize-all-games-graphics-performance | Copilot | ~7 | fix: finalize point 1 baseline telemetry |
| `b5ca5ac` | 2026-04-02 06:52 UTC | copilot/modernize-all-games-graphics-performance | Copilot | +2 ~5 | feat: add shared game baseline telemetry |
| `a2ba14c` | 2026-04-02 07:40 UTC | completedream | appthemanger-ctrl | — | Merge pull request #401 from appthemanger-ctrl/copilot/system-wide-ui-ux-upgrade |
| `ae45c42` | 2026-04-02 06:56 UTC | copilot/system-wide-ui-ux-upgrade | Copilot | ~6 | feat: add premium system shell styling |
| `61670fd` | 2026-04-02 06:46 UTC | completedream | appthemanger-ctrl | — | Merge pull request #400 from appthemanger-ctrl/copilot/update-system-audit-and-alignment |
| `08943e4` | 2026-04-02 06:03 UTC | copilot/update-system-audit-and-alignment | appthemanger-ctrl | — | Merge branch 'completedream' into copilot/update-system-audit-and-alignment |
| `78ca545` | 2026-04-02 05:09 UTC | copilot/update-system-audit-and-alignment | Copilot | ~9 | feat: align games surfaces with README and modern runtime UI |
| `19818b0` | 2026-04-02 05:01 UTC | completedream | appthemanger-ctrl | — | Merge pull request #399 from appthemanger-ctrl/copilot/add-video-features-to-feed |
| `cd478eb` | 2026-04-02 05:01 UTC | copilot/add-video-features-to-feed | appthemanger-ctrl | — | Merge branch 'completedream' into copilot/add-video-features-to-feed |
| `06d4624` | 2026-04-02 04:34 UTC | copilot/add-video-features-to-feed | Copilot | +1 ~3 | feat: add in-feed video playback, swipe navigation, expand modal, world news & music |
| `cffc4fa` | 2026-04-02 04:59 UTC | completedream | appthemanger-ctrl | — | Merge pull request #398 from appthemanger-ctrl/copilot/update-joystick-responsiveness |
| `b47cf69` | 2026-04-02 04:36 UTC | copilot/update-joystick-responsiveness | Copilot | ~5 | feat: game UI cleanup — faster joysticks, right-stick tap=jump, compact HUD, smaller gold orb |
| `a4432d1` | 2026-04-02 04:07 UTC | completedream | appthemanger-ctrl | ~1 | Update branch names for push triggers in workflow |
| `13dd9f0` | 2026-04-02 04:06 UTC | completedream | appthemanger-ctrl | +1 −1 | Update and rename Gengin.agent.md to gameengin-ai-agent.yml |
| `04bcd27` | 2026-04-02 03:26 UTC | completedream | appthemanger-ctrl | — | Merge pull request #397 from appthemanger-ctrl/copilot/fix-bot-email-in-idari-daily-yml |


---

## Current Implementation Status
Last updated: 2026-04-02 07:04 UTC — `6811ff2` by Copilot
Last updated: 2026-04-02 07:40 UTC — `a2ba14c` by appthemanger-ctrl
