...
<!-- Last regenerated: 2026-04-03 12:30 UTC — `6d506fc` on `copilot/improve-game-controls-and-ui` -->
...
| `tests/` | Vitest test suite (85 test files) |
...
| Routes | ~175 (101 pages + 74 API handlers) |
| Test files | 85 |
| Last push | `6d506fc` by **Copilot** on `copilot/improve-game-controls-and-ui` |
| Timestamp | 2026-04-03 12:30 UTC |
...
| `4b6b983` | 2026-04-03 12:25 UTC | copilot/improve-game-controls-and-ui | Copilot | ~5 | Improve game UI: landscape layout, wider joystick range, collapsible size pill, MADMAXI speed tuning & soundtrack |
| `b56a94c` | 2026-04-03 11:40 UTC | completedream | appthemanger-ctrl | — | Merge pull request #417 from appthemanger-ctrl/copilot/forge-everything-another-one |
| `3c429c4` | 2026-04-03 09:50 UTC | copilot/forge-everything-another-one | Copilot | ~5 | feat(forge): wire cross-engine transfers and add comprehensive forge activity recording |
| `32594e2` | 2026-04-03 09:40 UTC | completedream | appthemanger-ctrl | — | Merge pull request #416 from appthemanger-ctrl/copilot/forge-everything-again |
| `28e2092` | 2026-04-03 09:36 UTC | copilot/forge-everything-again | Copilot | ~3 | fix: address review feedback — shared history key constant, resilient test lookup |
| `6ce8723` | 2026-04-03 09:31 UTC | copilot/forge-everything-again | Copilot | +1 ~3 | feat: forge intelligence — predictive suggestions, goal parser, workflow runs, transfers, custom workflows, failure recovery |
| `eac2964` | 2026-04-03 09:09 UTC | copilot/forge-everything-again | Copilot | +1 ~10 | feat: forge everything — wire activity pulses into all 6 engines, add workflow launcher + activity timeline |
| `be4001f` | 2026-04-03 08:51 UTC | completedream | appthemanger-ctrl | — | Merge pull request #415 from appthemanger-ctrl/copilot/fix-prerender-connection-error |
| `19dc4cb` | 2026-04-03 08:11 UTC | copilot/fix-prerender-connection-error | Copilot | ~2 | fix: move connection() before try/catch in widget API routes to fix prerender error |


---

## Current Implementation Status
Last updated: 2026-04-03 12:30 UTC — `6d506fc` by Copilot
