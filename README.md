...
<!-- Last regenerated: 2026-04-02 23:26 UTC — `3cbba45` on `copilot/explain-repository-structure` -->
...
| Test files | 82 |
| Last push | `3cbba45` by **Copilot** on `copilot/explain-repository-structure` |
| Timestamp | 2026-04-02 23:26 UTC |
...
|---|---|---|---|---|---|
| `3cbba45` | 2026-04-02 23:26 UTC | copilot/explain-repository-structure | Copilot | ~1 | fix: sync StarMaker picker state and calm clip tool disclosure defaults |
| `de509f0` | 2026-04-02 23:20 UTC | copilot/explain-repository-structure | Copilot | ~3 | feat: use pickers for StarMaker assignments and disclosure trays for tools |
...
Last updated: 2026-04-02 23:26 UTC — `3cbba45` by Copilot
