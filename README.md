...
<!-- Last regenerated: 2026-04-12 01:09 UTC — `9f5aeed` on `copilot/fix-github-actions-updating-docs` -->

> **Documentation Owner:** José Mancilla (appthemanger-ctrl)  
> **Documentation Date:** 2026-04-12 01:09 UTC
...
| `tests/` | Vitest test suite (124 test files) |
...
| Routes | ~191 (102 pages + 89 API handlers) |
| Test files | 124 |
| Last push | `9f5aeed` by **copilot-swe-agent[bot]** on `copilot/fix-github-actions-updating-docs` |
| Timestamp | 2026-04-12 01:09 UTC |
...
Last updated: 2026-04-12 01:09 UTC — `9f5aeed` by copilot-swe-agent[bot]
...
Build Status: 191 routes (102 pages + 89 API handlers) · 124 test files
