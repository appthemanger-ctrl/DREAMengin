...
<!-- Last regenerated: 2026-04-03 14:35 UTC — `60d0a51` on `copilot/setup-webgpu-initialization` -->
...
| `tests/` | Vitest test suite (87 test files) |
...
| Test files | 87 |
| Last push | `60d0a51` by **Copilot** on `copilot/setup-webgpu-initialization` |
| Timestamp | 2026-04-03 14:35 UTC |
...
Last updated: 2026-04-03 14:35 UTC — `60d0a51` by Copilot
