...
import { ArrowLeft, BarChart2, TrendingUp, Bell, Target, Users, DollarSign, Calendar, Download } from 'lucide-react';
      ...
      <div className="de-sky-bg min-h-screen">
        <header className="sticky top-0 z-30 backdrop-blur-xl" style={{ background: 'rgba(255,255,255,0.85)', borderBottom: '1px solid rgba(160,195,240,0.3)' }}>
          <div className="max-w-2xl mx-auto px-4 py-3 flex items-center gap-3">
            ...
            <span className="text-xs px-2 py-1 rounded-full font-semibold" style={{ background: `rgba(99,102,241,0.1)`, color: ACCENT, border: `1px solid rgba(99,102,241,0.2)` }}>Daydream</span>
          </div>
        </header>
