  ...
  return (
    <div className="de-sky-bg min-h-screen">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 pb-24 space-y-4">
        ...
        <div className="de-widget" style={{ background: 'linear-gradient(135deg, rgba(42,138,184,0.12) 0%, rgba(200,152,26,0.10) 100%)', borderColor: 'rgba(42,138,184,0.3)' }}>
          ...
          <div className="de-widget-actions">
            ...
            <span style={{ fontSize: 11, color: 'var(--de-text-dim)', marginLeft: 'auto' }}>
              <Zap className="w-3 h-3 inline mr-1" style={{ color: 'var(--de-gold)' }} />3 levels · dual joystick
            </span>
          </div>
        </div>
        ...
        <div className="de-widget">
          <div className="de-widget-header">
            ...
            <span className="ml-auto text-xs font-semibold px-2 py-0.5 rounded-full" style={{ background: 'rgba(42,138,184,0.1)', color: 'var(--de-accent)', border: '1px solid rgba(42,138,184,0.2)' }}>Live</span>
          </div>
          <div className="de-widget-body">
            <WordSprint />
          </div>
        ...
        <div className="de-widget">
          ...
          <div className="de-widget-body flex flex-col items-center py-5 gap-3">
            ...
            <Link href="/game" className="de-btn de-btn-ghost text-xs">
              <Play className="w-3 h-3 fill-current" /> Start Dr. Eams
            </Link>
          </div>
        </div>
