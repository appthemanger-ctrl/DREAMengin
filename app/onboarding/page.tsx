...
const TIPS = [
  ...
  },
  {
    ...
    body: 'The gold button is your travel system. Single-tap to return to HomeDream. Double-tap to open the Daydreams menu (left) and DreamMenu (right).',
    action: null,
    color: '#c8981a',
  },
  {
    ...
    icon: '✏️',
    title: 'Edit Mode',
    body: 'Tap "Edit Layout" on your HomeDream to enter Edit Mode. You can drag, reorder, and add Dreams without accidentally moving things during normal use.',
    action: null,
    color: '#6366f1',
  },
  {
  ...
  },
  {
    step: 5,
    icon: '👤',
    title: 'ViewProfile — Your Public Output',
    body: 'ViewProfile at /profile/yourhandle shows only what you choose to publish from Edit ProfileDream. Everything else stays private — nothing is public by default.',
